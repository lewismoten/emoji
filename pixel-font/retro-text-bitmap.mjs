...
const blank = rows("00000", "00000", "00000", "00000", "00000", "00000", "00000");
...
const ACCENTS = {
  ...
  circumflex: rows("00100", "01010", "00000", "00000", "00000", "00000", "00000"),
  tilde: rows("01010", "10101", "00000", "00000", "00000", "00000", "00000"),
  diaeresis: rows("01010", "00000", "00000", "00000", "00000", "00000", "00000"),
  ring: rows("00100", "01010", "00100", "00000", "00000", "00000", "00000"),
};

function toMatrix(bitmap) {
  return Array.from({ length: 7 }, (_, row) => bitmap.slice(row * 5, row * 5 + 5).split(""));
}
...
function overlay(base, accent, shift = 1) {
  ...
  for (let row = 0; row < 7; row += 1) {
    ...
    if (sourceRow >= 0 && sourceRow < 7) result[row] = [...baseMatrix[sourceRow]];
  }
  for (let row = 0; row < 7; row += 1) {
