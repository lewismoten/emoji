...
const glyphOverrides = new Map(
  [
    ...
    ["å", ringABase],
    ["ɓ", rows("00100", "00100", "01110", "10101", "11110", "10000", "01110")],
    ["ć", overlayRows(BITMAP_FONT_5X7.c, accentRows.acute)],
    ["č", overlayRows(BITMAP_FONT_5X7.c, accentRows.caron)],
    ["ĉ", overlayRows(BITMAP_FONT_5X7.c, accentRows.circumflex)],
    ["ċ", overlayRows(BITMAP_FONT_5X7.c, accentRows.dotAbove)],
    ["ɔ", rows("00000", "00000", "01110", "10001", "10000", "10001", "01110")],
    ["ɗ", rows("00010", "00110", "00010", "01110", "10010", "10010", "01101")],
    ["ɖ", rows("00010", "00110", "00010", "01110", "10010", "10010", "01111")],
    ...
    ["ĕ", overlayRows(BITMAP_FONT_5X7.e, accentRows.breve)],
    ...
    ["ė", overlayRows(BITMAP_FONT_5X7.e, accentRows.dotAbove)],
    ["ẹ", replaceBottomRow(BITMAP_FONT_5X7.e, "00100")],
    ["ę", replaceBottomRow(BITMAP_FONT_5X7.e, "00011")],
    ["ě", overlayRows(BITMAP_FONT_5X7.e, accentRows.caron)],
    ["ə", rows("00000", "00000", "01110", "10001", "01111", "00001", "11110")],
    ["ɛ", rows("00000", "00000", "01110", "10001", "11110", "10000", "01110")],
    ["ƒ", rows("00110", "01001", "01000", "11100", "01000", "01000", "00100")],
    ["ĝ", overlayRows(BITMAP_FONT_5X7.g, accentRows.circumflex)],
    ["ġ", overlayRows(BITMAP_FONT_5X7.g, accentRows.dotAbove)],
    ["ģ", appendBottomMark(BITMAP_FONT_5X7.g, "00100")],
    ["ğ", overlayRows(BITMAP_FONT_5X7.g, accentRows.breve)],
    ["ɣ", rows("00000", "00000", "11110", "00001", "01111", "10001", "01110")],
    ["ĥ", overlayRows(BITMAP_FONT_5X7.h, accentRows.circumflex)],
    ["ħ", rows("10000", "10110", "11101", "10001", "10001", "10001", "10001")],
    ["í", overlayRows(BITMAP_FONT_5X7.i, accentRows.acute)],
    ["ı", rows("00000", "00000", "01100", "00100", "00100", "00100", "01110")],
    ["ĩ", overlayRows(BITMAP_FONT_5X7.i, accentRows.tilde)],
    ["ì", overlayRows(BITMAP_FONT_5X7.i, accentRows.grave)],
    ["î", overlayRows(BITMAP_FONT_5X7.i, accentRows.circumflex)],
    ["ị", replaceBottomRow(BITMAP_FONT_5X7.i, "00100")],
    ["ï", overlayRows(BITMAP_FONT_5X7.i, accentRows.diaeresis)],
    ["ī", overlayRows(BITMAP_FONT_5X7.i, accentRows.macron)],
    ["į", replaceBottomRow(BITMAP_FONT_5X7.i, "00011")],
    ["ǐ", overlayRows(BITMAP_FONT_5X7.i, accentRows.caron)],
    ["ĳ", rows("00100", "00000", "01101", "00101", "00101", "10101", "01101")],
    ["ĵ", overlayRows(BITMAP_FONT_5X7.j, accentRows.circumflex)],
    ["ķ", appendBottomMark(BITMAP_FONT_5X7.k, "00100")],
    ["ƙ", rows("01000", "01000", "01010", "01100", "11000", "01100", "01010")],
    ...
    ["ṅ", overlayRows(BITMAP_FONT_5X7.n, accentRows.dotAbove)],
    ["ɲ", rows("00000", "00000", "10110", "11001", "10001", "10010", "10001")],
    ["ŋ", rows("00000", "00000", "10110", "11001", "10001", "10001", "00001")],
    ...
    ["ọ", replaceBottomRow(BITMAP_FONT_5X7.o, "00100")],
    ["ő", overlayRows(BITMAP_FONT_5X7.o, accentRows.doubleAcute)],
    ["ŏ", overlayRows(BITMAP_FONT_5X7.o, accentRows.breve)],
    ["ơ", rows("00000", "00000", "01111", "10011", "10001", "10001", "01110")],
    ["ŕ", overlayRows(BITMAP_FONT_5X7.r, accentRows.acute)],
    ["r̃", overlayRows(BITMAP_FONT_5X7.r, accentRows.tilde)],
    ["ŗ", appendBottomMark(BITMAP_FONT_5X7.r, "00100")],
    ["ř", overlayRows(BITMAP_FONT_5X7.r, accentRows.caron)],
    ["ś", overlayRows(BITMAP_FONT_5X7.s, accentRows.acute)],
    ["ŝ", overlayRows(BITMAP_FONT_5X7.s, accentRows.circumflex)],
    ["ș", appendBottomMark(BITMAP_FONT_5X7.s, "00010")],
    ["ş", appendBottomMark(BITMAP_FONT_5X7.s, "00010")],
    ["ṣ", replaceBottomRow(BITMAP_FONT_5X7.s, "00100")],
    ...
    ["ţ", appendBottomMark(BITMAP_FONT_5X7.t, "00100")],
    ["ŧ", rows("01000", "11100", "01000", "11100", "01000", "01001", "00110")],
    ...
    ["ų", replaceBottomRow(accentedUBase, "00011")],
    ["ů", overlayRows(accentedUBase, accentRows.ring)],
    ["ũ", overlayRows(accentedUBase, accentRows.tilde)],
    ["ụ", replaceBottomRow(accentedUBase, "00100")],
    ["ŭ", overlayRows(accentedUBase, accentRows.breve)],
    ["ư", rows("00000", "00000", "10011", "10001", "10001", "10011", "01101")],
    ["ű", overlayRows(accentedUBase, accentRows.doubleAcute)],
    ["ʋ", rows("00000", "00000", "10001", "10001", "10001", "01010", "00110")],
    ["ý", overlayRows(BITMAP_FONT_5X7.y, accentRows.acute)],
    ["ƴ", rows("00000", "00000", "10001", "10001", "01111", "00001", "00110")],
    ["ÿ", overlayRows(BITMAP_FONT_5X7.y, accentRows.diaeresis)],
    ["ŵ", overlayRows(BITMAP_FONT_5X7.w, accentRows.circumflex)],
    ["ŷ", overlayRows(BITMAP_FONT_5X7.y, accentRows.circumflex)],
    ...
    ["Ɓ", rows("11110", "10001", "10001", "11110", "10001", "10011", "01110")],
    ["Ć", overlayRows(BITMAP_FONT_5X7.C, accentRows.acute)],
    ["Č", overlayRows(BITMAP_FONT_5X7.C, accentRows.caron)],
    ["Ĉ", overlayRows(BITMAP_FONT_5X7.C, accentRows.circumflex)],
    ["Ċ", overlayRows(BITMAP_FONT_5X7.C, accentRows.dotAbove)],
    ["Ď", overlayRows(BITMAP_FONT_5X7.D, accentRows.caron)],
    ["Ɗ", rows("01110", "01001", "11001", "10001", "10001", "10001", "11110")],
    ["Ɖ", rows("11110", "10001", "10101", "10101", "10101", "10001", "11110")],
    ...
    ["Ę", replaceBottomRow(BITMAP_FONT_5X7.E, "00011")],
    ["Ě", overlayRows(BITMAP_FONT_5X7.E, accentRows.caron)],
    ["Ə", rows("01110", "10000", "01110", "10001", "10001", "10001", "01110")],
    ["Ɛ", rows("01111", "10000", "10000", "11110", "10000", "10000", "01111")],
    ["Ƒ", rows("01111", "01000", "01000", "11100", "01000", "01000", "01000")],
    ["Ĝ", overlayRows(BITMAP_FONT_5X7.G, accentRows.circumflex)],
    ["Ģ", appendBottomMark(BITMAP_FONT_5X7.G, "00100")],
    ["Ğ", overlayRows(BITMAP_FONT_5X7.G, accentRows.breve)],
    ["Ġ", overlayRows(BITMAP_FONT_5X7.G, accentRows.dotAbove)],
    ["Ɠ", rows("01111", "10000", "10000", "10111", "10001", "10001", "01111")],
    ["Ɣ", rows("11110", "00001", "01111", "10001", "10001", "10001", "01110")],
    ["Ĥ", overlayRows(BITMAP_FONT_5X7.H, accentRows.circumflex)],
    ["Ħ", rows("10010", "10010", "11111", "10010", "10010", "10010", "10010")],
    ["İ", rows("00100", "11111", "00100", "00100", "00100", "00100", "11111")],
    ["Ī", overlayRows(BITMAP_FONT_5X7.I, accentRows.macron)],
    ["Ĩ", overlayRows(BITMAP_FONT_5X7.I, accentRows.tilde)],
    ["Ị", replaceBottomRow(BITMAP_FONT_5X7.I, "00100")],
    ["Į", replaceBottomRow(BITMAP_FONT_5X7.I, "00011")],
    ["Ĳ", rows("00100", "00100", "00100", "00100", "10101", "10101", "01101")],
    ["Ĵ", overlayRows(BITMAP_FONT_5X7.J, accentRows.circumflex)],
    ["Ķ", appendBottomMark(BITMAP_FONT_5X7.K, "00100")],
    ["Ƙ", rows("10001", "10010", "10100", "11000", "10100", "10010", "10011")],
    ["Ĺ", overlayRows(BITMAP_FONT_5X7.L, accentRows.acute)],
    ["Ļ", appendBottomMark(BITMAP_FONT_5X7.L, "00100")],
    ["Ľ", overlayRows(BITMAP_FONT_5X7.L, accentRows.caron)],
    ...
    ["Ņ", appendBottomMark(BITMAP_FONT_5X7.N, "00100")],
    ["Ň", overlayRows(BITMAP_FONT_5X7.N, accentRows.caron)],
    ["Ɲ", rows("10001", "10001", "11001", "10101", "10011", "10010", "10001")],
    ["Ŋ", rows("10001", "10001", "11001", "10101", "10011", "10001", "00001")],
    ["Ō", overlayRows(BITMAP_FONT_5X7.O, accentRows.macron)],
    ["Ọ", replaceBottomRow(BITMAP_FONT_5X7.O, "00100")],
    ["Ŏ", overlayRows(BITMAP_FONT_5X7.O, accentRows.breve)],
    ["Ő", overlayRows(BITMAP_FONT_5X7.O, accentRows.doubleAcute)],
    ["Ɔ", rows("01110", "10001", "10000", "10000", "10000", "10001", "01110")],
    ["Ơ", rows("01111", "10011", "10001", "10001", "10001", "10001", "01110")],
    ["Ŕ", overlayRows(BITMAP_FONT_5X7.R, accentRows.acute)],
    ["R̃", rows("01100", "00011", "11110", "10001", "11110", "10010", "10001")],
    ["Ŗ", appendBottomMark(BITMAP_FONT_5X7.R, "00100")],
    ["Ř", overlayRows(BITMAP_FONT_5X7.R, accentRows.caron)],
    ["Ś", overlayRows(BITMAP_FONT_5X7.S, accentRows.acute)],
    ["Ŝ", overlayRows(BITMAP_FONT_5X7.S, accentRows.circumflex)],
    ...
    ["Ť", overlayRows(BITMAP_FONT_5X7.T, accentRows.caron)],
    ["Ț", appendBottomMark(BITMAP_FONT_5X7.T, "00010")],
    ["Ŧ", rows("11111", "00100", "11111", "00100", "00100", "00100", "00100")],
    ["Ʋ", rows("10001", "10001", "10001", "10001", "10001", "10010", "01100")],
    ["Ū", overlayRows(BITMAP_FONT_5X7.U, accentRows.macron)],
    ["Ụ", replaceBottomRow(BITMAP_FONT_5X7.U, "00100")],
    ["Ų", replaceBottomRow(BITMAP_FONT_5X7.U, "00011")],
    ["Ŭ", overlayRows(BITMAP_FONT_5X7.U, accentRows.breve)],
    ["Ů", overlayRows(BITMAP_FONT_5X7.U, accentRows.ring)],
    ["Ũ", overlayRows(BITMAP_FONT_5X7.U, accentRows.tilde)],
    ["Ư", rows("10011", "10001", "10001", "10001", "10001", "10001", "01110")],
    ["Ű", overlayRows(BITMAP_FONT_5X7.U, accentRows.doubleAcute)],
    ["Ŵ", overlayRows(BITMAP_FONT_5X7.W, accentRows.circumflex)],
    ["Ƴ", rows("10001", "10001", "01010", "00100", "00100", "00110", "00001")],
    ["Ŷ", overlayRows(BITMAP_FONT_5X7.Y, accentRows.circumflex)],
    ["Ź", overlayRows(BITMAP_FONT_5X7.Z, accentRows.acute)],
    ["Ż", overlayRows(BITMAP_FONT_5X7.Z, accentRows.dotAbove)],
    ["Ž", overlayRows(BITMAP_FONT_5X7.Z, accentRows.caron)],
...
const supplementaryGlyphs = [
  ...
  {
    character: "↔",
    bitmap: rows("00000", "00100", "01010", "11111", "01010", "00100", "00000"),
  },
  {
    character: "↕",
    bitmap: rows("00100", "01110", "00100", "10101", "00100", "01110", "00100"),
  },
  {
    character: "↶",
    bitmap: rows("00110", "01000", "10111", "10001", "10101", "01001", "00110"),
  },
  {
    character: "↷",
    bitmap: rows("01100", "00010", "11101", "10001", "10101", "10010", "01100"),
  },
  {
    character: "⌘",
    bitmap: rows("01010", "10101", "01010", "10101", "01010", "10101", "01010"),
  },
  {
    character: "◐",
    bitmap: rows("01110", "11001", "11001", "11001", "11001", "11001", "01110"),
  },
];
...
const manifest = {
  ...
  samplePhrases: [
    ...
    {
      id: "african",
      label: "African Latin example",
      text: "Ɓ Ɗ Ƙ Ẹ Ọ Ṣ Ị Ṅ Ụ Ɖ Ɛ Ƒ Ɣ Ɔ Ʋ Ƴ Ɲ ɓ ɗ ƙ ẹ ọ ṣ ị ṅ ụ ɖ ɛ ƒ ɣ ɔ ʋ ƴ ɲ",
    },
  ],
  sampleScale: 4,
  sampleWrap: 28,
  pages: [
    ...
    {
      id: "extended-latin-and-symbols",
      image: "extended-latin-and-symbols.png",
      map: "extended-latin-and-symbols.json",
      label: "Extended Latin & symbols",
      cellSize: 16,
      glyphBox: { x: 5, y: 4, width: 5, height: 7 },
      rangeStart: 8192,
      rangeEnd: 8703,
