...
describe("help-settings-dialog", () => {
  it("renders help/settings content and its dependent styles", () => {
    ...
    try {
      ...
      assert.equal(dialog.className, "dialog musical help-dialog");
      ...
      assert.match(markup, /class="dialog musical help-dialog"/);
