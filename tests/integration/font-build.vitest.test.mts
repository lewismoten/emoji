...
describe("font-build integration", () => {
  it("preserves font build, packaging, and publishing contracts", async () => {
    ...
    assert.match(
      ...
      "Pages validation must enforce manifest and font signatures",
    );
  });
});
