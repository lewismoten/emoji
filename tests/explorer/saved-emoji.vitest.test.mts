...
describe("saved-emoji", () => {
  it("updates saved key collections and labels", () => {
    ...
    assert.equal(
      savedEmojiLabel("wrappedGift", {}, {
        wrappedGift: { shortName: "Wrapped gift" },
      }),
      "Wrapped gift",
    );
  });

  it("renders saved emoji lists and updates controller state", () => {
