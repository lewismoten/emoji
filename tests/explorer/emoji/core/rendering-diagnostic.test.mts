...
assert.deepEqual(
  ...
  }),
  {
    ...
    regularEditorHidden: false,
    split: false,
    resultText: "systemRenderingComposed:✓ The system displayed one composed emoji.",
  },
);
...
assert.deepEqual(
  ...
  }),
  {
    ...
    regularEditorHidden: false,
    split: false,
    resultText: "systemRenderingSingle:The system and Pixel Emoji renderings are shown above.",
  },
);
