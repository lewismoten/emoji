...
describe("pwa-panels branches", () => {
  it("covers installation, manifest, focus, and open-panel fallback branches", async () => {
    ...
    focusPanelDialog(
      "favorites",
      favoriteDialog as unknown as HTMLDialogElement,
      {
        renderSavedEmoji() {},
      },
    );
