...
describe("search-language-picker-render", () => {
  it("renders language options and preserves selected locale behavior", async () => {
  ...
  it("navigates via selectLanguageLink only for primary unmodified clicks", async () => {
    let prevented = 0;
    ...
    (fixture.documentStub as any).baseURI =
      "http://fallback.test/base/index.en.html";
    await selectLanguageLink(
      {
        button: 0,
        metaKey: false,
