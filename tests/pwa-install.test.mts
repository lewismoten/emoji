...
const [
  ...
  Promise.all([
    ...
    read("src/site/themes/retro-foundation.css"),
    read("src/site/themes/retro-dialogs.css"),
    read("src/site/themes/retro-buttons.css"),
    read("src/site/themes/retro-forms.css"),
    read("src/site/themes/retro-focus.css"),
