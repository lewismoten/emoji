...
export const demoScript = await fs.readFile(path.join(root, 'src/index.ts'), 'utf8');
...
export const viteConfig = await fs.readFile(path.join(root, 'vite.config.js'), 'utf8');
