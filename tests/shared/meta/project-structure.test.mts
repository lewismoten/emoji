...
const legacyLineBudgets: Record<string, number> = {
  ...
  "tests/app/category-controller.vitest.test.mts": 522,
  "tests/explorer/ui/explorer-ui-branches.vitest.test.mts": 341,
  "tests/explorer/ui/explorer-ui-theme-font.vitest.test.mts": 359,
  "tests/explorer/audio/explorer-audio-engine.vitest.test.mts": 482,
  ...
  "tests/explorer/category/category-filter-render.vitest.test.mts": 421,
  "tests/explorer/control-startup.vitest.test.mts": 507,
  "tests/explorer/dialog/dialog-render.test.mts": 466,
  "tests/explorer/dialog/dialog-upgrade.test.mts": 431,
  "tests/explorer/emoji/emoji-list-render.vitest.test.mts": 507,
  "tests/explorer/language/language-dialog-control.test.mts": 441,
  "tests/explorer/language/search-language-lifecycle.vitest.test.mts": 499,
  "tests/explorer/navigation/explorer-navigation-direct.vitest.test.mts": 543,
