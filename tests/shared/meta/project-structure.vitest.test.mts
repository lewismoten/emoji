...
const legacyLineBudgets: Record<string, number> = {
  ...
  "tests/explorer/emoji/emoji-list-interaction.vitest.test.mts": 368,
  "tests/explorer/dialog/dialog-render.vitest.test.mts": 519,
  "tests/explorer/dialog/dialog-view.vitest.test.mts": 372,
  "tests/explorer/dialog/dialog-upgrade.vitest.test.mts": 452,
  "tests/explorer/dialog/parts/dialog-title-controls.vitest.test.mts": 312,
  ...
  "tests/explorer/navigation/event-accessibility.vitest.test.mts": 302,
  ...
  "tests/explorer/utility/runtime/utility-controls-fixture.mts": 304,
  "tests/pixel-editor/controllers/pixel-editor-atlas.test.mts": 346,
  "tests/pixel-editor/controllers/pixel-editor-atlas.vitest.test.mts": 318,
  "tests/pixel-editor/controllers/pixel-editor-transfer.test.mts": 405,
  "tests/pixel-editor/controllers/pixel-editor-transfer.vitest.test.mts": 591,
  "tests/pixel-editor/controllers/setup/pixel-editor-controller-visual.vitest.test.mts": 356,
