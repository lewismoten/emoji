...
const legacyLineBudgets: Record<string, number> = {
  ...
  "tests/app/bootstrap/explorer-bootstrap-runtime.vitest.test.mts": 477,
  ...
  "tests/explorer/dialog/dialog-render.vitest.test.mts": 488,
  ...
  "tests/shared/meta/project-structure.vitest.test.mts": 325,
};
