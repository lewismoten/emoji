...
export async function createBootstrapSessionFixture() {
  ...
  await writeStub("shell-stub.mjs", [
    ...
    " renderPixelFontToggle: 'render-pixel-font-toggle', renderSavedEmoji: 'render-saved-emoji',",
    " selectEmojiFont: 'select-emoji-font', toggleDeveloperMode: 'toggle-developer-mode',",
