...
describe("pixel-editor-template", () => {
  it("renders the expected editor markup", () => {
    ...
    assert.equal(
      markup.includes('class="pixel-editor-preview-official"'),
      true,
    );
    ...
    assert.equal(
      markup.includes('class="pixel-editor-layer-help" hidden'),
      true,
    );
    ...
    assert.equal(
      markup.includes('data-layer-transform="flip-horizontal"'),
      true,
    );
