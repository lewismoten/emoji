...
assert.equal(sessionOptions.downloadButton, fixture.elements.downloadButton);
...
assert.equal(sessionOptions.renderController, fixture.visual.renderController);
assert.equal(
