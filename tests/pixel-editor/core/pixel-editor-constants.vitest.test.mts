...
describe("pixel-editor-constants", () => {
  it("exports stable constants and helpers", () => {
    ...
    assert.equal(typeof IS_VITE_DEVELOPMENT, "boolean");
    assert.equal(IS_VITE_DEVELOPMENT, isViteDevelopment(import.meta.env));
