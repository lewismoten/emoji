...
describe("pixel-editor-skin-tone-basics", () => {
  it("covers skin tone helper basics and comparison rules", () => {
    ...
    assert.equal(
      endpointSkinToneShadeAny(medium.codePoint, "lighter"),
      undefined,
    );
    assert.equal(
      endpointSkinToneShadeAny(dark.codePoint, "lighter"),
      undefined,
    );
    assert.equal(
      endpointSkinToneShadeAny(light.codePoint, "darker"),
      undefined,
    );
    assert.deepEqual(
      Array.from(
        skinToneColorMapAny(light.codePoint, medium.codePoint).entries(),
      ),
      [
    ...
    assert.deepEqual(
      Array.from(
        skinToneColorMapAny(dark.codePoint, light.codePoint).entries(),
      ),
      [
