...
// Pairing source: ../../../src/pixel-editor/data/pixel-editor-atlas-io.js
  ...
  it("covers atlas IO helpers and input controller flows", async () => {
    ...
    try {
      ...
      const input = module.createPixelEditorInputController({
        ...
        dialog: { open: true },
        draftController: {
          pushHistory: () => editorCalls.push("push-history"),
        },
        ...
        updateTransferButtons: () =>
          editorCalls.push("update-transfer-buttons"),
        view: { hidden: false },
      });
      ...
      const floatingInput = module.createPixelEditorInputController({
        ...
        paletteController: {
          pickColor: () => editorCalls.push("pick-color-2"),
        },
        pixels: () => new Uint8ClampedArray([1, 2, 3, 4]),
